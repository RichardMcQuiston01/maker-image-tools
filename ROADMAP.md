...
| ------------------------ | -------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------- | --------------------------------------------------------------------------- |
| `apps/accounts`          | User identity                                                              | Auth (OAuth/email), sessions, entitlements/plan tier                                                                                      | Node/TS + Postgres                  | Stage 6 — **already built** (email/password + sessions; OAuth still open)   |
...
| `apps/material-db`       | Crowdsourced material settings (speed/power presets by material × machine) | Submission/review API, versioned presets, search                                                                                          | Node/TS + Postgres                  | Stage 6 — **already built** (Stage 4B's static JSON can migrate here later) |
