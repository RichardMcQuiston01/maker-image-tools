...
offer as their _core_ feature set is classic, deterministic image/vector/G-code
...
Not because the algorithm needs a backend, but because the _feature itself_ is
